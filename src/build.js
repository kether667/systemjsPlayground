System.registerDynamic("github:angular/bower-angular@1.4.3/angular.js", [], false, function(__require, __exports, __module) {
...
System.registerDynamic("github:angular/bower-angular@1.4.3.js", ["github:angular/bower-angular@1.4.3/angular.js"], true, function(require, exports, module) {
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = require("github:angular/bower-angular@1.4.3/angular.js");
  global.define = __define;
  return module.exports;
});
...
System.register('js/app/controllers/rootCtrl.js', ['npm:babel-runtime@5.7.0/helpers/create-class.js', 'npm:babel-runtime@5.7.0/helpers/class-call-check.js'], function (_export) {
    var _createClass, _classCallCheck, RootCtrl;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('default', RootCtrl);
        }
    };
});
System.register('js/bootstrap.js', ['github:angular/bower-angular@1.4.3.js', 'js/app/controllers/rootCtrl.js'], function (_export) {
    'use strict';

    var angular, RootCtrl;
    ...
    return {
        setters: [function (_githubAngularBowerAngular143Js) {
            angular = _githubAngularBowerAngular143Js['default'];
        }, function (_jsAppControllersRootCtrlJs) {
            RootCtrl = _jsAppControllersRootCtrlJs['default'];
        }],
        execute: function () {}
    };
});
System.register('js/main.js', ['js/bootstrap.js'], function (_export) {
  'use strict';

  var bootstrap;
  return {
    setters: [function (_jsBootstrapJs) {
      bootstrap = _jsBootstrapJs['default'];
    }],
    execute: function () {
      bootstrap();
    }
